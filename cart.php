...
?>
	...
	<br/><br/>
	<a href="checkout.php" class="btn btn-primary">Mua</a> 
	<a href="books.php" class="btn btn-primary">Tiếp Tục Mua Sách</a>
<?php
	} else {
		echo "<p class=\"text-warning\">Giỏ của bạn trống trơn! Hãy chắc chắn rằng bạn thêm một số sách trong đó!</p>";
	}
