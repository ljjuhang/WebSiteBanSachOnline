...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Nhà Sách 16CT</a>
        </div>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>Chào mừng bạn đến với nhà sách 16CT trực tuyến</h1>
        <p class="lead">Chúc các bạn tìm được sách mình yêu thích!</p>
        <p>Nhớ đeo khẩu trang và hạn chế ra khỏi nhà trừ khi có việc cần thiết!</p>
      </div>
    </div>
    <?php } ?>
