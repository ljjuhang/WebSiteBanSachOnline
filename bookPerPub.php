...
?>
	<p class="lead"><a href="publisher_list.php">Nhà Xuất Bản</a> > <?php echo $pubName; ?></p>
...
?>
	<div class="row">
		...
		<div class="col-md-7">
			...
			<a href="book.php?bookisbn=<?php echo $row['book_isbn'];?>" class="btn btn-primary">Xem Chi Tiết</a>
		</div>
	</div>
	<br>
<?php
