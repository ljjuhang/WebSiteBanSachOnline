...
?>
	...
	<form method="post" action="purchase.php" class="form-horizontal">
		...
		<div class="form-group">
			<label for="city" class="control-label col-md-4">Mã Bưu Điện</label>
			<div class="col-md-4">
				<input type="text" name="city" class="col-md-4" class="form-control">
			</div>
		</div>
		<div class="form-group">
			<label for="zip_code" class="control-label col-md-4">Số Điện Thoại</label>
			<div class="col-md-4">
	...
	<p class="lead">Vui lòng nhấn Thanh Toán để xác nhận mua hàng của bạn hoặc Tiếp tục mua sắm để thêm hoặc xóa các mặt hàng.</p>
<?php
	} else {
