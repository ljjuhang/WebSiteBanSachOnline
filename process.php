<?php
	...
	session_unset();
?>
	<p class="lead text-success">Đơn hàng của bạn đã được xử lý thành công. Vui lòng kiểm tra email của bạn để có được xác nhận đặt hàng và chi tiết vận chuyển!
	Giỏ hàng của bạn đã trống rỗng.</p>
